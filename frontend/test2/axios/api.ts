...
export const TestControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         * @param {string} test 
         * @param {number} testNumb 
         * @param {string} testParam 
         * @param {RequestParamDTO} requestParamDTO 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getTest: async (test: string, testNumb: number, testParam: string, requestParamDTO: RequestParamDTO, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'test' is not null or undefined
            assertParamExists('getTest', 'test', test)
            // verify required parameter 'testNumb' is not null or undefined
            assertParamExists('getTest', 'testNumb', testNumb)
            // verify required parameter 'testParam' is not null or undefined
            assertParamExists('getTest', 'testParam', testParam)
            // verify required parameter 'requestParamDTO' is not null or undefined
            assertParamExists('getTest', 'requestParamDTO', requestParamDTO)
            const localVarPath = `/test/{test}/b/{testNumb}`
                .replace(`{${"test"}}`, encodeURIComponent(String(test)))
                .replace(`{${"testNumb"}}`, encodeURIComponent(String(testNumb)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            if (testParam !== undefined) {
                localVarQueryParameter['testParam'] = testParam;
            }

            if (requestParamDTO !== undefined) {
                for (const [key, value] of Object.entries(requestParamDTO)) {
         ...
         * @param {string} testParam 
         * @param {RequestParamDTO} requestParamDTO 
         * @param {RequestBodyDTO} requestBodyDTO 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        postTest: async (test: string, testNumb: number, testParam: string, requestParamDTO: RequestParamDTO, requestBodyDTO: RequestBodyDTO, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'test' is not null or undefined
            assertParamExists('postTest', 'test', test)
            // verify required parameter 'testNumb' is not null or undefined
            assertParamExists('postTest', 'testNumb', testNumb)
            // verify required parameter 'testParam' is not null or undefined
            assertParamExists('postTest', 'testParam', testParam)
            // verify required parameter 'requestParamDTO' is not null or undefined
            assertParamExists('postTest', 'requestParamDTO', requestParamDTO)
            // verify required parameter 'requestBodyDTO' is not null or undefined
            assertParamExists('postTest', 'requestBodyDTO', requestBodyDTO)
            const localVarPath = `/test/{test}/b/{testNumb}`
                .replace(`{${"test"}}`, encodeURIComponent(String(test)))
                .replace(`{${"testNumb"}}`, encodeURIComponent(String(testNumb)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(requestBodyDTO, localVarRequestOptions, configuration)
...
export const TestControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getTest(test: string, testNumb: number, testParam: string, requestParamDTO: RequestParamDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getTest(test, testNumb, testParam, requestParamDTO, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['TestControllerApi.getTest']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async postTest(test: string, testNumb: number, testParam: string, requestParamDTO: RequestParamDTO, requestBodyDTO: RequestBodyDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.postTest(test, testNumb, testParam, requestParamDTO, requestBodyDTO, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['TestControllerApi.postTest']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const TestControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getTest(test: string, testNumb: number, testParam: string, requestParamDTO: RequestParamDTO, options?: RawAxiosRequestConfig): AxiosPromise<string> {
            return localVarFp.getTest(test, testNumb, testParam, requestParamDTO, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} test 
         ...
         * @throws {RequiredError}
         */
        postTest(test: string, testNumb: number, testParam: string, requestParamDTO: RequestParamDTO, requestBodyDTO: RequestBodyDTO, options?: RawAxiosRequestConfig): AxiosPromise<string> {
            return localVarFp.postTest(test, testNumb, testParam, requestParamDTO, requestBodyDTO, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class TestControllerApi extends BaseAPI {
     ...
     */
    public getTest(test: string, testNumb: number, testParam: string, requestParamDTO: RequestParamDTO, options?: RawAxiosRequestConfig) {
        return TestControllerApiFp(this.configuration).getTest(test, testNumb, testParam, requestParamDTO, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TestControllerApi
     */
    public postTest(test: string, testNumb: number, testParam: string, requestParamDTO: RequestParamDTO, requestBodyDTO: RequestBodyDTO, options?: RawAxiosRequestConfig) {
        return TestControllerApiFp(this.configuration).postTest(test, testNumb, testParam, requestParamDTO, requestBodyDTO, options).then((request) => request(this.axios, this.basePath));
    }
}
