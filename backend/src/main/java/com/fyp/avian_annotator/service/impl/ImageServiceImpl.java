...
public class ImageServiceImpl implements ImageService {
  ...
  public String uploadImage(
    ...
    s3Service.uploadFile(bucketKey, contentType, metaData, inputStream, size);
  ...
  public ImageResponseDTO createDownloadPresignedUrlForImage(
    ...
    // not n + 1...right?
    var url =
        s3Service.createGetPresignedUrl(image.getWorkspace().getBucketPrefix() + bucketIdentifier);
    ...
    return new ImageResponseDTO(
        url, workspaceId, image.getFileName(), image.getBucketIdentifier(), null);
  }
